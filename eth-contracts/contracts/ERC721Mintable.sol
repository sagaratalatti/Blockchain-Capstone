...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == owner || isApprovedForAll(owner, msg.sender), "The sender is not the owner of the contract or approved");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) && to != address(0), "Token already exits or address is invalid");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "Is not the owner of the token");
...
contract CraveuERC721Token is ERC721MetaData {

    constructor()
    ERC721MetaData("Craveu", "CRVE", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") public {
